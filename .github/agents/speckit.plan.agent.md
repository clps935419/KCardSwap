...
2. **Align API specification** from functional requirements:
   ...
   - Keep `openapi/openapi.json` updated as a generated snapshot of the implemented API (useful for validation/SDK generation; not a pre-dev contract; requirements discussion still comes from spec/plan/tasks)
