...
export class ReportsService {
     ...
     * @throws ApiError
     */
    public static getMyReportsApiV1ReportsGet(data: GetMyReportsApiV1ReportsGetData = {}): CancelablePromise<GetMyReportsApiV1ReportsGetResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/reports',
            cookies: {
...
export class ChatService {
     ...
     * @throws ApiError
     */
    public static getChatRoomsApiV1ChatsGet(data: GetChatRoomsApiV1ChatsGetData = {}): CancelablePromise<GetChatRoomsApiV1ChatsGetResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/chats',
            cookies: {
...
export class PostsService {
     ...
     * @param data.postId
     * @param data.accessToken
     * @returns PostResponseWrapper Post retrieved successfully
     * @throws ApiError
     */
    public static getPostApiV1PostsPostIdGet(data: GetPostApiV1PostsPostIdGetData): CancelablePromise<GetPostApiV1PostsPostIdGetResponse> {
        return __request(OpenAPI, {
            method: 'GET',
...
export class GalleryService {
     ...
     * @throws ApiError
     */
    public static getMyGalleryCardsApiV1GalleryCardsMeGet(data: GetMyGalleryCardsApiV1GalleryCardsMeGetData = {}): CancelablePromise<GetMyGalleryCardsApiV1GalleryCardsMeGetResponse> {
        return __request(OpenAPI, {
            method: 'GET',
