...
class ProfileResponse(BaseModel):
    ...
    preferences: Optional[Dict[str, Any]] = Field(default_factory=dict, description="User preferences (JSON)")
...
class UpdateProfileRequest(BaseModel):
    ...
    privacy_flags: Optional[Dict[str, bool]] = Field(None, description="Privacy settings")
