...
from app.modules.identity.application.use_cases.profile.get_profile import GetProfileUseCase
from app.modules.identity.application.use_cases.profile.update_profile import UpdateProfileUseCase
...
async def get_my_profile(
    ...
    profile_response = ProfileResponse(
        ...
        privacy_flags=profile.privacy_flags or {
            "nearby_visible": True,
            "show_online": True,
