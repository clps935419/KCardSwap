...
class SendFriendRequestUseCase:
    ...
    async def execute(self, user_id: str, friend_id: str) -> Friendship:
        ...
        existing_friendship = await self.friendship_repository.get_by_users(user_id, friend_id)
        ...
        if await self.friendship_repository.is_blocked(user_id, friend_id):
            raise ValueError("Cannot send friend request - you are blocked by this user")
