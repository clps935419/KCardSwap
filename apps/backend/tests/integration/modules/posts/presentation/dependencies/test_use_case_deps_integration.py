...
class TestPostsUseCaseDependenciesIntegration:
    ...
    @pytest.mark.asyncio
    async def test_get_create_post_use_case(self, test_app_with_injector, db_session):
    ...
    @pytest.mark.asyncio
    async def test_get_toggle_like_use_case(self, test_app_with_injector, db_session):
    ...
    @pytest.mark.asyncio
    async def test_session_correctly_bound(self, test_app_with_injector, db_session):
